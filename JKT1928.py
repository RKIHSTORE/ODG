...
• GEHAH : http://github.com/RKIHSTORE•
• GROUP : CYBER MASK BUNNY •

   {h}Rikod Aungtor RKIH" STORE ''')                                           
#--------------------[ Ɑ͞ ̶͞ ̶͞ ඩMASUK ]--------------#
def login():
	try:
...
def menu(my_name,my_id):
	...
	if _____Rkih__Store_____ in ['1']:
		dump_massal()
	elif _____Rkih__Store_____ in ['2']:
		dump_follower()
	elif _____Rkih__Store_____ in ['3']:
		grup()
	elif _____Rkih__Store_____ in ['4']:
		crack_file()
	elif _____Rkih__Store_____ in ['5']:
		result()
	elif _____Rkih__Store_____ in ['0']:
