...
██║░░██║██║██████╔╝██║░╚██╗██║
╚═╝░░╚═╝╚═╝╚═════╝░╚═╝░░╚═╝╚═╝ 
                  {m}▪︎{k}▪︎{h}▪︎{sir} RKIH STORE {x}{m}▪︎{k}▪︎{h}▪︎{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
...
def menu(name,id):
	...
	print('\x1b[1;93m[\x1b[1;92m▪︎\x1b[1;93m] \x1b[1;92mGithub      : \x1b[1;93mGAPUNYA')
	...
	_____RKIH__STORE_____ = input('\n\x1b[1;93m[\x1b[1;92m?\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mPilih > \x1b[1;93m')
	print('')
	if _____RKIH__STORE_____ in ['01','1']:
		dump_massal()
	elif _____RKIH__STORE_____ in ['02','2']:
	    dump_public()
	elif _____RKIH__STORE_____ in ['03','3']:
	    cek_opsi()
	elif _____RKIH__STORE_____ in ['04','4']:
	    result()
	elif _____RKIH__STORE_____ in ['05','5']:
	    doa_halal()
	elif _____RKIH__STORE_____ in ['07','7']:
	    akun_facebook()
	elif _____RKIH__STORE_____ in ['Bot','BOT','bot']:
	    bot()
	elif _____RKIH__STORE_____ in ['lainnya','Lainnya','LAINNYA']:
	    lainnya()
	elif _____RKIH__STORE_____ in ['00','0']:
